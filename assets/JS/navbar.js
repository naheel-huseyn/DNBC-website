          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle px-2 text-danger fw-semibold"  href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  TOP CITIES
                </a>
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a  class="dropdown-item" href="tokyo.html">TOKYO</a></li>
                  <li><a class="dropdown-item" href="dehli.html">DELHI</a></li>
                  <li><a class="dropdown-item" href="shanghai.html">SHANGHAI</a></li>
